...
const SliderBox = (props) => {
  ...
  return (
    <>
      <div
        id="slider-container"
        className="container mx-auto px-5 py-5 mt-10 shadow-lg border-b border-gray-200 sm:rounded-md bg-white grid xs:grid-rows-2 md:grid-rows-0 md:grid-cols-2 "
      >
        ...
        >
          <div className="mt-5 slider-title flex justify-center">
            ...
            <h3 className="px-5 slider-title-value">
              {formatter.format(priceSliderData).replace(",00", "")}
            </h3>
          </div>
          <Slider
            aria-label="Price"
          ...
          <div
            id=""
            className="slider-title flex justify-center sm:mt-5 lg:mt-0"
          >
