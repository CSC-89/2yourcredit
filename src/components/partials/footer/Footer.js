...
const Footer = () => {
  return (
    <>
      ...
      <footer style={{backgroundColor: "rgb(0, 145, 255"}} className="absolute botton-0 pb-3 w-full flex justify-between inline">
...
/*
 ...
 <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="space-y-4 lg:space-y-0 lg:flex lg:items-center lg:justify-between xl:mt-0">
